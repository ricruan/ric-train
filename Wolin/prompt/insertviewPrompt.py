...
- 合并文本，融合掉重复内容
- 区分面试官和求职者的对话内容
- 基于基本信息对部分内容进行矫正以确保语句通顺，禁止过度矫正，优先保持原始文本的语义
...
COMBINE_SLICE_PROMPT_V2= """
## 背景
处理面试录音的ASR转化文本，它被滑动切片成多份文本，需要进行合并。
...
### 输出
你好，欢迎来参加今天的面试。先简单介绍一下你自己吧，重点讲讲和这个岗位相关的工作或项目经历。您好，我叫李明，本科毕业于XX大学计算机专业，研究生在XX大学读了人工智能方向。我有三年多的产品经验，主要聚焦在AI产品与智能助手方向。最近两年，我在一家智能客服公司担任AI产品经理，负责智能对话系统与AI Agent相关产品的规划与落地，包括意图识别优化、多轮对话管理，以及基于大模型的新一代智能代理产品的设计。很高兴能来面试这个岗位。很好，你提到你负责过 AI Agent 类产品，可以具体说一下你做过最核心的一个项目吗？你在这个项目中承担了什么样的角色？好的。我主导过一个基于大语言模型的“智能客服 Agent”项目，目标是让客服机器人不仅能解答常见问题，还能根据用户上下文做智能引导、任务拆解，甚至自主执行一些简单操作，比如查询订单、申请退款等。
"""
